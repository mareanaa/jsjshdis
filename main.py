...
stopuser = {}
token = '7367990601:AAF_o5dRcC-jhhD96zNhv4wm1qtYveUd8d8'
...
𝗕𝗼𝘁 𝗕𝘆: @the_FJU</b>'''
					if "Funds" in last or 'Invalid postal' in last or '1000: Approved' in last or 'added' in last or 'Duplicate' in last: 
						live += 1
...
𝙏𝙞𝙢𝙚 ➼ {"{:.1f}".format(execution_time)}
𝗕𝗼𝘁 𝗕𝘆: @the_FJU</b>'''
	if "Funds" in last or 'Invalid postal' in last or '1000: Approved' in last or 'added' in last or 'Duplicate' in last or 'Approved' in last:
